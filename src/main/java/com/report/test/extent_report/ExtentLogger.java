...
public final class ExtentLogger {
  ...
  public static void logResponse(final String response) {
    ExtentManager.getTest().info("Response Body details below");
    ExtentManager.getTest().info(MarkupHelper.createCodeBlock(response));
  }
